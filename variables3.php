...
<button type="button" class="start-test hidden">Start test</button>
<main class="hi">
<div class="question-container ">


<?php
require "variableq3.php";



if(isset ($_SESSION["exist"])){

echo "<p class='bg-danger text-white text-enter'>"
...
<a href="profile.php?url=variables4">Next</a>
